package com.hengbang.hbcrm.hb.customer.mapper;

import com.github.pagehelper.Page;
import com.hengbang.hbcrm.hb.customer.mapper.sql.CustomerSql;
...
public interface CustomerMapper {
    ...
    @Results({
            ...
            @Result(property = "list", column = "uuid",
                    many = @Many(
                            select = "com.hengbang.hbcrm.hb.customer.mapper.CusImgMapper.findByCusid")
            )
    })
